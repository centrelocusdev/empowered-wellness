...
const Mindfulness = () => {
  ...
  return (
    <div className="md:px-8 px-4 md:w-4/5 mx-auto py-4">
      ...
      {type == types[1] && (
        <div>
          <LargeHeading text={'breathing exericise'} goTo={'/mindfulness'} desc={'Breathing exercises involve slow, deep breaths that can reduce stress and improve overall health. They\'re easy to do anywhere and have benefits like lower blood pressure and reduced anxiety.'} />
